<div id="memory-flip-container" class="absolute inset-0 flex flex-col items-center justify-center p-6 text-center" x-data="memoryFlipGame()">
    ...
    <div x-show="gameState === 'start'" class="max-w-md">
        ...
        <h2 class="text-3xl font-cinzel font-bold mb-4">Memory Flip</h2>
...
<script>
    document.addEventListener('alpine:init', () => {
        if(!Alpine.data('memoryFlipGame')) {
            Alpine.data('memoryFlipGame', () => ({
                gameState: 'start',
                score: 100,
                cards: [],
                selectedCards: [],
