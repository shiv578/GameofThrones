<div id="empire-builder-container" class="absolute inset-0 flex flex-col items-center justify-center p-6 text-center" x-data="empireBuilderGame()">
    ...
    <div x-show="gameState === 'start'" class="max-w-md">
        ...
        <h2 class="text-3xl font-cinzel font-bold mb-4">Empire Builder</h2>
...
<script>
    document.addEventListener('alpine:init', () => {
        if(!Alpine.data('empireBuilderGame')) {
            Alpine.data('empireBuilderGame', () => ({
                gameState: 'start',
                score: 0,
                gold: 0,
                iron: 0,
                ...
                trainSoldier() {
                    if(this.gold >= 20 && this.iron >= 20) {
                        ...
                        alert('Insufficient resources to draft army!');
                    }
                },
