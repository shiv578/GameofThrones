<div id="sequence-recall-container" class="absolute inset-0 flex flex-col items-center justify-center p-6 text-center" x-data="sequenceRecallGame()">
    ...
    <div x-show="gameState === 'start'" class="max-w-md">
        ...
        <h2 class="text-3xl font-cinzel font-bold mb-4">Sequence Recall</h2>
...
<script>
    document.addEventListener('alpine:init', () => {
        if(!Alpine.data('sequenceRecallGame')) {
            Alpine.data('sequenceRecallGame', () => ({
                gameState: 'start',
                score: 0,
                level: 1,
                sequence: [],
