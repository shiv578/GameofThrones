<div id="hidden-object-container" class="absolute inset-0 flex flex-col items-center justify-center p-6 text-center" x-data="hiddenObjectGame()">
...
<script>
    document.addEventListener('alpine:init', () => {
        if(!Alpine.data('hiddenObjectGame')) {
            Alpine.data('hiddenObjectGame', () => ({
                gameState: 'start',
                score: 0,
                sequence: [],
                playerSequence: [],
