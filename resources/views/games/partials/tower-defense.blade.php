<div id="tower-defense-container" class="absolute inset-0 flex flex-col items-center justify-center p-6 text-center overflow-hidden" x-data="towerDefenseGame()">
...
<script>
    document.addEventListener('alpine:init', () => {
        if(!Alpine.data('towerDefenseGame')) {
            Alpine.data('towerDefenseGame', () => ({
                gameState: 'start',
                score: 0,
                lives: 3,
                walkers: [],
