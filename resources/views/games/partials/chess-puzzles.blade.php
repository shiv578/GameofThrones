<div id="chess-puzzles-container" class="absolute inset-0 flex flex-col items-center justify-center p-6 text-center" x-data="chessPuzzlesGame()">
...
<script>
    document.addEventListener('alpine:init', () => {
        if(!Alpine.data('chessPuzzlesGame')) {
            Alpine.data('chessPuzzlesGame', () => ({
                gameState: 'start',
                currentQuestion: 0,
                score: 0,
                questions: [
